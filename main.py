...
def main():
	...
	win_tournament_by_round, win_round_by_round, lose_round_by_round, win_tournament_by_round_L, win_round_by_round_L, lose_round_by_round_L, all_winners = tournament(3, 1000)
	...
	visualize(win_round, "Test", "Probability")
